...
sudo dnf install -y snapd mercurial vim ctags git-extras docker autojump make autoconf autogen libtool flex bison openconnect pwgen ranger dialog yadm python3-pip pylint pandoc tmux htop jq golang bat python3-pypandoc twine python3-autopep8 kubernetes-client
